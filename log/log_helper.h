...
public:
    ...
    bool init_logger_cmd(const std::string& logger_name);
...
#define LOG_INFO(msg, ...)  spdlog::get(LOG_HELPER->get_logger_name())->info(msg, ##__VA_ARGS__)
#define LOG_DEBUG(msg, ...) spdlog::get(LOG_HELPER->get_logger_name())->debug(msg, ##__VA_ARGS__)
#define LOG_WARN(msg, ...)  spdlog::get(LOG_HELPER->get_logger_name())->warn(msg, ##__VA_ARGS__)
#define LOG_ERROR(msg, ...) spdlog::get(LOG_HELPER->get_logger_name())->error(msg, ##__VA_ARGS__)
#endif